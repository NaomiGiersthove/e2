<?php 
    ...
    $hapjes = $db->select(" SELECT menuitems.ID, menuitems.Code, menuitems.Naam, menuitems.Prijs ,gerechtsoorten.ID AS soort_ID ,gerechtcategorien.Naam AS soort, gerechtsoorten.Naam AS soort_naam FROM menuitems 
